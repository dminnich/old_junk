...
BZIP2=`type -p bzip2`
#Location of slapcat. Set manually if below doesn't work. 
SLAPCAT=`type -p slapcat`
...
#Remove ALL FILES in the destination directory that are over 50 days old.
# This is used to prune backups.   
$FIND $DESTINATION -type f -atime +50 -print | $XARGS $RM
#Backup the databases.  
$SLAPCAT | $BZIP2 -c >$DESTINATION/$HOSTNAME-$DATE.bz2
